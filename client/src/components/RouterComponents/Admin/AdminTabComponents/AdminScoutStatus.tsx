        ...
        const redData = [
            {
                ...
                status: this.getStatusIcon(
                    this.props.scoutStatus['r-s1-scout']
                ),
            },
            {
                key: 's2',
                ...
                status: this.getStatusIcon(
                    this.props.scoutStatus['r-s2-scout']
                ),
            },
            {
                key: 's3',
                ...
                status: this.getStatusIcon(
                    this.props.scoutStatus['r-s3-scout']
                ),
            },
        ];
        const blueData = [
            {
                ...
                status: this.getStatusIcon(
                    this.props.scoutStatus['b-s1-scout']
                ),
            },
            {
                key: 's2',
                ...
                status: this.getStatusIcon(
                    this.props.scoutStatus['b-s2-scout']
                ),
            },
            {
                key: 's3',
                ...
                status: this.getStatusIcon(
                    this.props.scoutStatus['b-s3-scout']
                ),
            },
        ];
        return (

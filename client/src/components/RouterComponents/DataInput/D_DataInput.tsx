                ...
                this.props.socket.emit(
                    ...
                    (
                        ...
                        if (remainingTime < 0) {
                            ...
                            const identifier = `${
                                this.props.scoutingTargets[0].alliance === 'red'
                                    ? 'r'
                                    : 'b'
                            ...
                            this.setState({
                                ...
                                phase,
                                autoButtonsDisabled:
                                    phase === 'AUTO' ? false : true,
                                teleopButtonsDisabled:
                                    phase === 'TELEOP' ? false : true,
                                endgameButtonsDisabled:
                                    phase === 'ENDGAME' ? false : true,
                            });
                        }
                    }
                );
    ...
    render() {
        ...
        return (
          ...
          'match team'"
                    ...
                    cols="1fr 1fr"
                    gridElements={[
                        <h1 style={{ gridArea: 'time' }}>
                            Time: {this.state.matchTime}s
                        </h1>,
                        <h1 style={{ gridArea: 'phase' }}>
                            Phase: {this.state.phase}
                        </h1>,
                        <h2 style={{ gridArea: 'match' }}>
                            Match: {this.props.matchNumber}
                        </h2>,
                        <h2 style={{ gridArea: 'team' }}>
                            Team: {scoutingTargets}
                        </h2>,
                    ]}
                />
                <Grid
              ...
              'bottom'"
                            gridElements={[
                                ...
                                <AccuracyEventButton
                                    ...
                                    label="Bottom "
                                    type={
                                        EScorableRobotEvents.POWERCELLS_BOTTOM
                                    }
                                    disabled={this.state.globalDisabled}
                                    phase={
                                        this.state.phase === 'NONE'
              ...
              'initiation    . '"
                            gridElements={[
                                ...
                                <RobotEventButton
                                    ...
                                    disabled={
                                        this.state.globalDisabled ||
                                        this.state.autoButtonsDisabled
                                    }
                                    phase={
                                        this.state.phase === 'NONE'
                                            ? 'AUTO'
